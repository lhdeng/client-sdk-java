    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        "(org.web3j.protocol.core.methods.request.PlatoneFilter filter) {\n"
                        + "    return web3j.platoneLogObservable(filter).map(new rx.functions.Func1<org.web3j.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        ...
                        + "    org.web3j.protocol.core.methods.request.PlatoneFilter filter = new org.web3j.protocol.core.methods.request.PlatoneFilter(startBlock, endBlock, getContractAddress());\n"
