 ...
 */
public class PlatoneFilter extends Filter<PlatoneFilter> {
    ...
    public PlatoneFilter() {
        super();
    }

    public PlatoneFilter(DefaultBlockParameter fromBlock, DefaultBlockParameter toBlock,
                        List<String> address) {
        super();
