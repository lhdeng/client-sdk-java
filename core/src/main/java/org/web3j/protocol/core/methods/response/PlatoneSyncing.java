 ...
 */
public class PlatoneSyncing extends Response<PlatoneSyncing.Result> {

    @Override
    @JsonDeserialize(using = PlatoneSyncing.ResponseDeserialiser.class)
    public void setResult(PlatoneSyncing.Result result) {
