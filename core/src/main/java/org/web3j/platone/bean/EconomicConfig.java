...
public class EconomicConfig {
    ...
    public class Reward {
         ...
         */
        private BigInteger platoneFoundationYear;
        ...
        public BigInteger getPlatoneFoundationYear() {
            return platoneFoundationYear;
        }

        public void setPlatoneFoundationYear(BigInteger platoneFoundationYear) {
            this.platoneFoundationYear = platoneFoundationYear;
        }
        ...
        public String toString() {
            return "Reward{" +
                    ...
                    ", platoneFoundationYear=" + platoneFoundationYear +
                    '}';
        }
    }
    ...
    public class InnerAcc {
         ...
         * 基金会账号地址
         */
        private String platoneFundAccount;
        /**
         * 基金会初始金额
         */
        private BigInteger platoneFundBalance;
        /**
         * 社区开发者账户
         */
        ...
        public String getPlatoneFundAccount() {
            return platoneFundAccount;
        }

        public void setPlatoneFundAccount(String platoneFundAccount) {
            this.platoneFundAccount = platoneFundAccount;
        }

        public BigInteger getPlatoneFundBalance() {
            return platoneFundBalance;
        }

        public void setPlatoneFundBalance(BigInteger platoneFundBalance) {
            this.platoneFundBalance = platoneFundBalance;
        }
        ...
        public String toString() {
            return "InnerAcc{" +
                    "platoneFundAccount='" + platoneFundAccount + '\'' +
                    ", platoneFundBalance=" + platoneFundBalance +
