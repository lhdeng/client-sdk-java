...
public class SystemParameter {
    ...
    public String toString() {
        return "SystemParameter [blockGasLimit=" + blockGasLimit + ", txGasLimit=" + txGasLimit + ", isTxUseGas="
            + isTxUseGas + ", isProduceEmptyBlock=" + isProduceEmptyBlock + ", enableDeploy=" + enableDeploy + "]";
    }
