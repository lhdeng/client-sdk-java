...
public class ParamManager extends Contract {
	...
	protected ParamManager(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider,
			Long chainId) {
		super(BINARY, InnerContractEnum.ParamManager.getAddress(), web3j, transactionManager, contractGasProvider,
				chainId);
	}

	public RemoteCall<TransactionReceipt> DisableDeploy() {
		final Function function = new Function(FUNC_DISABLEDEPLOY, Arrays.<Type>asList(),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}

	public RemoteCall<TransactionReceipt> EnableDeploy() {
		final Function function = new Function(FUNC_ENABLEDEPLOY, Arrays.<Type>asList(),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}
	...
	public RemoteCall<TransactionReceipt> UpdateIsProduceEmptyBlock(Boolean isProduceEmptyBlock) {
		final Function function = new Function(FUNC_UPDATEISPRODUCEEMPTYBLOCK,
				Arrays.<Type>asList(new org.web3j.abi.datatypes.Bool(isProduceEmptyBlock)),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}

	public RemoteCall<TransactionReceipt> UpdateIsTxUseGas(Boolean isTxUseGas) {
		final Function function = new Function(FUNC_UPDATEISTXUSEGAS,
				Arrays.<Type>asList(new org.web3j.abi.datatypes.Bool(isTxUseGas)),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}

	public RemoteCall<TransactionReceipt> UpdateSystemParameter(BigInteger blockGasLimit, BigInteger txGasLimit,
			Boolean isTxUseGas, Boolean isProduceEmptyBlock, Boolean enableDeploy) {
		final Function function = new Function(FUNC_UPDATESYSTEMPARAMETER,
				Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint64(blockGasLimit),
						new org.web3j.abi.datatypes.generated.Uint64(txGasLimit),
						new org.web3j.abi.datatypes.Bool(isTxUseGas),
						new org.web3j.abi.datatypes.Bool(isProduceEmptyBlock),
						new org.web3j.abi.datatypes.Bool(enableDeploy)),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}

	public RemoteCall<TransactionReceipt> UpdateTxGasLimit(BigInteger txGasLimit) {
		final Function function = new Function(FUNC_UPDATETXGASLIMIT,
				Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint64(txGasLimit)),
				Collections.<TypeReference<?>>emptyList());
		return executeRemoteCallTransaction(function);
	}

	public static ParamManager load(Web3j web3j, Credentials credentials, GasProvider contractGasProvider,
			Long chainId) {
		return new ParamManager(web3j, credentials, contractGasProvider, chainId);
	}

	public static ParamManager load(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider,
			Long chainId) {
