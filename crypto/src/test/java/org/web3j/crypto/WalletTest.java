...
public class WalletTest {
	...
	private void testCreate(WalletFile walletFile) throws Exception {
		assertEquals(walletFile.getAddress(), SampleKeys.TESTNET_BECH32_ADDRESS);
	}

	@Test
	public void testCreateSm2Standard() throws Exception {
		testCreateSm2(Wallet.createStandard(SampleKeys.PASSWORD, SampleKeys.SM2_KEY_PAIR));
	}

	@Test
	public void testCreateSm2Light() throws Exception {
		testCreateSm2(Wallet.createLight(SampleKeys.PASSWORD, SampleKeys.SM2_KEY_PAIR));
	}

	private void testCreateSm2(WalletFile walletFile) throws Exception {
		assertEquals(walletFile.getAddress(), SampleKeys.SM2_BECH32_ADDRESS);
	}
	...
	@Test
	public void testEncryptDecryptSm2Standard() throws Exception {
		testEncryptDecryptSm2(Wallet.createStandard(SampleKeys.PASSWORD, SampleKeys.SM2_KEY_PAIR));
	}

	@Test
	public void testEncryptDecryptSm2Light() throws Exception {
		testEncryptDecryptSm2(Wallet.createLight(SampleKeys.PASSWORD, SampleKeys.SM2_KEY_PAIR));
	}

	private void testEncryptDecryptSm2(WalletFile walletFile) throws Exception {
		assertThat(Wallet.decryptSm2(SampleKeys.PASSWORD, walletFile), equalTo(SampleKeys.SM2_KEY_PAIR));
	}
