...
public class KeysTest {
	...
	public void testGetAddressString() {
		assertThat(Keys.getAddress(SampleKeys.PUBLIC_KEY_STRING), is(SampleKeys.HEX_ADDRESS_NO_PREFIX));
	}
	...
	public void testGetAddressBigInteger() {
		assertThat(Keys.getAddress(SampleKeys.PUBLIC_KEY), is(SampleKeys.HEX_ADDRESS_NO_PREFIX));
	}

	@Test
	public void testGetAddressSmallPublicKey() {
		byte[] address = Keys.getAddress(Numeric.toBytesPadded(BigInteger.valueOf(0x1234), Keys.PUBLIC_KEY_SIZE));
	...
	public void testGetAddressZeroPadded() {
		...
		String value = "1234";
		assertThat(Keys.getAddress("0x" + Strings.zeros(Keys.PUBLIC_KEY_LENGTH_IN_HEX - value.length()) + value),
				equalTo(expected));
	}

	@Test
	public void testGetSm2AddressZeroPadded() {
		byte[] address = Keys.getSm2Address(Numeric.toBytesPadded(BigInteger.valueOf(0x1234), Keys.PUBLIC_KEY_SIZE));
		String expected = Numeric.toHexStringNoPrefix(address);

		String value = "1234";
		assertThat(Keys.getSm2Address("0x" + Strings.zeros(Keys.PUBLIC_KEY_LENGTH_IN_HEX - value.length()) + value),
				equalTo(expected));
	}
	...
	@Test
	public void testCreateSm2EcKeyPair() {
	...
	@Test
	public void testGetSm2Address() {
		assertThat(Keys.getAddress(SampleKeys.SM2_KEY_PAIR), is(SampleKeys.SM2_HEX_ADDRESS_NO_PREFIX));

		assertThat(Keys.getSm2Address(SampleKeys.SM2_PUBLIC_KEY), is(SampleKeys.SM2_HEX_ADDRESS_NO_PREFIX));

		assertThat(Keys.getSm2Address(SampleKeys.SM2_PUBLIC_KEY_HEX), is(SampleKeys.SM2_HEX_ADDRESS_NO_PREFIX));

		byte[] b = Keys.getSm2Address(Numeric.toBytesPadded(SampleKeys.SM2_PUBLIC_KEY, Keys.PUBLIC_KEY_SIZE));

		byte[] b2 = Numeric.hexStringToByteArray(SampleKeys.SM2_HEX_ADDRESS);
