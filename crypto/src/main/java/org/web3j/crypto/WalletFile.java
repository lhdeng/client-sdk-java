...
public class WalletFile {
	...
	public static class Crypto {
		...
		@JsonSubTypes({ @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = Wallet.AES_128_CTR),
				@JsonSubTypes.Type(value = ScryptKdfParams.class, name = Wallet.SCRYPT) })
		// To support my Ether Wallet keys uncomment this annotation & comment
		// out the above
	...
	// If we need to work with MyEtherWallet we'll need to use this
	// deserializer, see the
	...
	static class KdfParamsDeserialiser extends JsonDeserializer<KdfParams> {
		...
		public KdfParams deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
			...
			// it would be preferable to detect the class to use based on the
			// kdf parameter in the
